...
export const ADMIN_METRICS: MetricCardData[] = [
  ...
  },
  {
    ...
    sparkline: [1860, 1920, 1990, 2040, 2095, 2140],
  },
  {
    id: "adm-4",
...
export const MANAGER_METRICS: MetricCardData[] = [
  ...
  },
  {
    ...
    trend: {
      value: "+12.0h",
      direction: "up",
      timeframe: "vs target pace",
      isPositive: true,
    },
    sparkline: [142.0, 154.5, 166.0, 178.0, 186.5],
  },
  {
    id: "mgr-4",
...
export const EMPLOYEE_METRICS: MetricCardData[] = [
  ...
  },
  {
    ...
    label: "Due this week",
    value: 3,
    trend: { value: "3 due", direction: "neutral", timeframe: "this sprint" },
    sparkline: [3, 3, 3, 3, 3],
  },
  {
    id: "emp-3",
    ...
    sparkline: [7.5, 15.0, 23.0, 31.0, 38.5],
  },
  {
    id: "emp-4",
    ...
    trend: { value: "0 days", direction: "neutral", timeframe: "next 30d" },
